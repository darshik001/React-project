              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3" controlId="movieGenre">
                  ...
                  <InputGroup>
                    ...
                    <Form.Select name="genre" value={inputForm.genre} onChange={handleChange}>
                ...
                <Form.Group className="mb-3" controlId="movieIndustry">
                  ...
                  <InputGroup>
                    ...
                    <Form.Select name="industry" value={inputForm.industry} onChange={handleChange}>
                ...
                <Form.Group className="mb-3" controlId="movieLanguage">
                  ...
                  <InputGroup>
                    ...
                    <Form.Select name="language" value={inputForm.language} onChange={handleChange}>
