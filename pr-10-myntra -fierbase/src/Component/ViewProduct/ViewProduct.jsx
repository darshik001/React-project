...
const handalEdit = (id)=>{
  ...
  return (
    <Container fluid className="mt-4">
      {isLoding?(<div className="d-flex justify-content-center my-5"><Spinner/></div>)
      :<Row className="mt-3">
        ...
        <Col md={6}>
          ...
          <div className="d-flex gap-3 mb-4">
            <Button
              variant="danger"
              className="px-4 py-2 d-flex align-items-center fw-bold" onClick={()=>handalDelete(product.id,product.category)}
            >
